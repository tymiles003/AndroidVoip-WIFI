...
public class ChatActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void makeCall() {
        if (ipAddress != null && contactName != null){
            Intent callIntent = new Intent (this, CallActivity.class);
            callIntent.putExtra("CONTACT_NAME", contactName);
            callIntent.putExtra("CALL_STATE", "OUTGOING");
            ...
            Toast.makeText (this, "Contact data missing!", Toast.LENGTH_SHORT).show ();
        }
